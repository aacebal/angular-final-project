...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__beer_service__ = __webpack_require__("../../../../../src/app/beer.service.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__app_component__ = __webpack_require__("../../../../../src/app/app.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__signup_login_signup_login_component__ = __webpack_require__("../../../../../src/app/signup-login/signup-login.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__beer_search_beer_search_component__ = __webpack_require__("../../../../../src/app/beer-search/beer-search.component.ts");
...
AppModule = __decorate([
    __webpack_require__.i(__WEBPACK_IMPORTED_MODULE_1__angular_core__["b" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_10__signup_login_signup_login_component__["a" /* SignupLoginComponent */],
            __WEBPACK_IMPORTED_MODULE_11__beer_search_beer_search_component__["a" /* BeerSearchComponent */],
        ...
        providers: [__WEBPACK_IMPORTED_MODULE_6__session_service__["a" /* SessionService */], __WEBPACK_IMPORTED_MODULE_7__user_service__["a" /* UserService */], __WEBPACK_IMPORTED_MODULE_8__beer_service__["a" /* BeerService */]],
...
var BeerSearchComponent = (function () {
    function BeerSearchComponent(BeerService, session, userService, router) {
    ...
    BeerSearchComponent.prototype.ngOnInit = function () {
        ...
        this.userService.userInfoSubject.subscribe(function (userInfo) {
            _this.user = userInfo;
            console.log("USER IN BEER SEARCH COMPONENT" + _this.user.name);
        });
    };
...
BeerSearchComponent = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_1__beer_service__["a" /* BeerService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1__beer_service__["a" /* BeerService */]) === "function" && _a || Object, typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_2__session_service__["a" /* SessionService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__session_service__["a" /* SessionService */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_3__user_service__["a" /* UserService */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__user_service__["a" /* UserService */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_4__angular_router__["b" /* Router */]) === "function" && _d || Object])
], BeerSearchComponent);
...
var SignupLoginComponent = (function () {
    function SignupLoginComponent(session, userService, router) {
        this.session = session;
        this.userService = userService;
        this.router = router;
...
var UserService = (function () {
    function UserService() {
        this.userInfoSubject = new __WEBPACK_IMPORTED_MODULE_1_rxjs_Subject__["Subject"]();
    }
    UserService.prototype.sendUserInfo = function (userInfo) {
...
var UserComponent = (function () {
    function UserComponent(session, userService, router) {
        this.session = session;
        this.userService = userService;
        this.router = router;
    }
    UserComponent.prototype.ngOnInit = function () {
        ...
        this.userService.userInfoSubject.subscribe(function (userInfo) {
            _this.user = userInfo;
            console.log("USER IN USER COMPONENT" + _this.user.name);
        });
    };
